class WeaponLabelMaker:
    ...
    llverbs = [
    ]  #None but the weakest status effects (smoldering, numbing, sparking, stinking etc)
    mlverbs = [
    ]  #Slight status effects (frosting, embering, shocking, sickening, etc)
    hlverbs = [
    ]  #Some status effect ( numb < chill < freeze) contaminating, burning, etc.
    ...
    def __init__(self):
        ...
        self.lladjectives.append(
            "Chaotic")  #Deals random damage to player and enemy
        ...
        self.lladjectives.append(
            "Frangible")  #Template Why not teach english while we play...? :D
        ...
        #Harmful
        self.mladjectives.append(
            "Tainted")  #Hurts the attacker with each attack
        self.mladjectives.append(
            "Chaotic"
        )  #Deals random range of heavy damage to attacked, less to attacker
