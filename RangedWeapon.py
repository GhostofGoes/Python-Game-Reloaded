...
class RangedWeapon:
    ...
    def drawReticle():
        ...
        pygame.draw.circle(Display.DISPLAYSURF, Display.WHITE,
                           (reticlePos[0], reticlePos[1]), 10)

    def aimAtPlayer(self, playerObj):
        self.playerPosX = playerObj.collisionx
        self.playerPosY = playerObj.collisiony
        pygame.draw.circle(Display.DISPLAYSURF, Display.WHITE,
                           (playerObj.collisionx, playerObj.collisiony), 10)
    ...
    def shoot(self):
        ...
        self.arrows.append(
            Projectile.Projectile(self.owner.x, self.owner.y, reticlePos[0],
                                  reticlePos[1], self.damage))
