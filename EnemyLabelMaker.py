...
class EnemyLabelMaker:
    ...
    def __init__(self):
        ...
        self.adjectives.append(
            "Stalking"
        )  #changes enemy-to-player pathing logic OR moves through doors?
        self.adjectives.append(
            "Perceptive")  #Finds player if they're in the same room
        ...
        self.adjectives.append(
            "Cowardly")  #runs away from player in certain range
